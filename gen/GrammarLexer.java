...
public class GrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "DATOVY_TYP", "STREDNIK", "MINUS", 
			"MODULO", "SPOJENI_RETEZCU", "RELACNI_OPERATORY_POROVNANI", "LOGICKEANDOR", 
			"LOGICKENOT", "PRIRAZENI", "FLOAT", "INT", "BOOLEAN", "VARIABLE", "STRINGSPECIAL", 
			"STRINGFIRSTPART", "STRING", "COMMENT", "WS"
		};
	}
